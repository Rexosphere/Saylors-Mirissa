      ...
      <div class=" bg-orange-50  py-6 px-8  rounded-t-2xl inline-block">
        <div class="flex flex-wrap items-center gap-6">
          ...
          <div class="flex items-center gap-3 p-4 rounded-lg min-w-[200px]">
            ...
            <div class="flex-1">
              <label class="text-stone-400 text-xs">Check In</label>
          ...
          <div class="flex items-center gap-3 p-4 rounded-lg min-w-[200px]">
            ...
            <div class="flex-1">
              <label class="text-stone-400 text-xs">Check Out</label>
          ...
          <div class="flex items-center gap-3 p-4 rounded-lg min-w-[200px]">
            ...
            <div class="flex-1">
              <label class="text-stone-400 text-xs">No of adults</label>
              <input type="number" name="adults" id="adults" min="1" max="20" 
                     class="w-full text-black text-base bg-transparent border-none outline-none"
                     value="3">
            </div>
          </div>
          ...
          <div class="flex items-center gap-3 p-4 rounded-lg min-w-[200px]">
            <div class="w-6 h-6 bg-teal-500 rounded"></div>
            <div class="flex-1">
              <label class="text-stone-400 text-xs">No of children</label>
          ...
          <!-- Check Now Button -->
          <button class="bg-[#72B6B9] hover:bg-[#5A8E91] text-white px-8 py-4 rounded-lg font-bold transition-colors">
            CHECK NOW
          </button>
